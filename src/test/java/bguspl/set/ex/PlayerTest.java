...
class PlayerTest {
    ...
    void terminate()
    {
        boolean expectedTerminate=!(player.getTerminate());
        player.terminate();
        assertEquals(expectedTerminate,player.getTerminate());
    }

    @Test
    void penaltyTime()
    {
        boolean expectedValue=!(player.getPenaltyTime());
        player.setPenaltyTime(expectedValue);
        assertEquals(expectedValue,player.getPenaltyTime());
    }

    @Test
    void pointTime()
    {
        boolean expectedValue=!(player.getPointTime());
        player.setPointTime(expectedValue);
        assertEquals(expectedValue,player.getPointTime());
    }
